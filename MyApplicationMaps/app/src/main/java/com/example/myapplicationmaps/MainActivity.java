...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    ProgressBar pBar;
    double mLatitude = 0; //garis bujur
    double mLongitude = 0; //garis lintang
    ...
    private void initMap() {
        ...
        //cek permission untuk mendapatkan lokasi terkini
        ...
        if (mGoogleMap != null) { //jk lokasi null maka akan menampilkan maps
            startProg();
